...
<div class="row">
    <div class="col-xl-12">
        <div class="card-box">
            ...
            <h4 class="header-title mt-0 mb-3">{{ trans('admin.edit_directory') }}</h4>


            {!! Form::model($directory, ['route' => ['directory.update', app()->getLocale(), $directory->id], "enctype" => "multipart/form-data"]) !!}
